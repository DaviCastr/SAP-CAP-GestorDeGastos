        ...
        onPressMensal: async function (oEvent) {
            ...
            try {
                ...
                const
                    ...
                    oGenercTile = oEvent.getSource(),
                    oIdCategoria = oEvent.getSource().getId().split('::')[1];

                sap.ui.core.BusyIndicator.show();

                let oAdicionaDetalhamento = function (flix, oRetorno, oGenercTile) {
                    ...
                    flix.addFixContent(
                        ...
                        new sap.m.VBox({
                            ...
                            items: [new sap.m.GenericTile({
                                headerImage: oGenercTile.getHeaderImage(),
                                header: oGenercTile.getHeader(),
                                subheader: oGenercTile.getSubheader(),
                                frameType: "OneByOne",
                                tileContent:
                                    new sap.m.TileContent({
                                        footer: oGenercTile.getTileContent()[0].getFooter(),
                                        content: new sap.suite.ui.microchart.RadialMicroChart({
                                            size: "Responsive",
                                            percentage: oGenercTile.getTileContent()[0].getContent().getPercentage(),
                                            valueColor: oGenercTile.getTileContent()[0].getContent().getValueColor(),
                                            alignContent: "Center"
                                        }),
                                    })
                            })]
                ...
                if (oRetorno?.Cartoes) {
                    if (!Fragment.byId("DetalhamentoCategoria", "dialogTransacoesPorCategoria")) {
                        this._detalhamentoDialog = Fragment.load({
                            ...
                            oAdicionaDetalhamento(oFlix, oRetorno, oGenercTile);
                            dialog.open();
                            return dialog;
                        }.bind(this));
                    } else {
                ...
                let oAdicionaDetalhamento = function (flix, oRetorno, oGenercTile) {
                    ...
                    flix.addFixContent(
                        ...
                        new sap.m.VBox({
                            ...
                            justifyContent:"Center",
                            items: [new sap.m.GenericTile({
                                headerImage: oGenercTile.getTileContent()[0].getContent().getItems()[0].getSrc(),
                                header: oGenercTile.getHeader(),
                                subheader: oGenercTile.getSubheader(),
                                frameType: "OneByOne",
                                tileContent:
                                    new sap.m.TileContent({
                                        ...
                                        content: new sap.suite.ui.microchart.RadialMicroChart({
                                            size: "Responsive",
                                            percentage: oGenercTile.getTileContent()[0].getContent().getItems()[1].getPercentage(),
                                            valueColor: oGenercTile.getTileContent()[0].getContent().getItems()[1].getValueColor(),
                                            alignContent: "Center"
                                        }),
                                    })
                            })]
